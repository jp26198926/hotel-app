...
export default function AdminPage() {
  ...
  const categories = [
    { id: "System", label: "System", color: "bg-blue-500", icon: Settings },
    { id: "Content", label: "Content", color: "bg-green-500", icon: Home },
    { id: "Hotel", label: "Hotel", color: "bg-purple-500", icon: Hotel },
    {
      id: "Restaurant",
      label: "Restaurant",
      color: "bg-orange-500",
    ...
    { id: "Events", label: "Events", color: "bg-red-500", icon: Calendar },
    {
      id: "Finance",
      label: "Finance",
      color: "bg-yellow-500",
    ...
    { id: "Security", label: "Security", color: "bg-gray-500", icon: Shield },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      >
        ...
        {/* Navigation */}
        <nav className="mt-5 px-2 space-y-1 max-h-[calc(100vh-80px)] overflow-y-auto">
                ...
                <div className="hidden md:flex items-center space-x-2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                    />
                  </div>
                </div>
